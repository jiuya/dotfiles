...
package=(gcc make git neovim tmux zsh curl sakura compton htop fcitx volumeicon-alsa network-manager-gnome dunst feh lightdm i3 suckless-tools i3blocks cmake clang libssl-dev scrot exuberant-ctags sxiv imagemagick i3lock xss-lock)
